...
Patch::Patch(Engine *e) {
    ...
    //this->objEngine->WriteStaticMemory(dwJnzAddress, &bPatchDebug, false);
...
void Patch::Range() {
    ...
    */
    ...
    WriteProcessMemory(this->objEngine->hFlyff, (LPVOID)dwJAAddress, &bRangeNew, 13, NULL);
    WriteProcessMemory(this->objEngine->hFlyff, (LPVOID)dwJNEAddress, &bRangeCallNew, 2, NULL);
}
